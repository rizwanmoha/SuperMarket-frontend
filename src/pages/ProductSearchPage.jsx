  ...
  useEffect(() => {
    const fetchProducts = async () => {
      let response = await fetch(
        `https://supermarket-backend-u1dn.onrender.com/api/products/search?q=${searchInput}&customerRating=${customerRating}&priceLL=0&priceUL=${priceSliderValue}&RuggedVerrified=${isRuggedVerrified}&colours=${color}&availability=${availability}&noOfResultsPerPage=12&pageNo=${page}&categories=${categories}&brands=${brands}`
      );
